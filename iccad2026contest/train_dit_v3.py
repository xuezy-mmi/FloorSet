#!/usr/bin/env python3
"""
train_dit_v3.py - DiT training v3 (items 1-5 from improvement plan)

Improvements over v2:
  4) Use the v3 model (graph conditioning) so b2b / p2b / pins / constraints
     actually enter the model. Removes the broken pos_embed.
  5) Hard-constraint override is in the inference optimizer (dit_optimizer_v3.py).

Items 1-3 from v2 are inherited.

Saves to /home/xzy/eda/model/v3/diffusion_final.pth.
"""
import math
import sys
...
# Reuse v2 helpers
from train_dit_v2 import vectorized_diff_loss, compute_norm_stats, ALPHA, BETA
...
def main():
    ...
    for epoch in range(N_EPOCHS):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            loss = loss_diff + LAMBDA_NOISE * loss_noise
